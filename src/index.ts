...
class Cli {
  async getDepartments(): Promise<string[]> {
    try {
      const result = await pool.query(
        `SELECT ARRAY(SELECT department_name FROM department)`
      );
  ...
  async getManagers(): Promise<string[]> {
    try {
      const result = await pool.query(
        `SELECT ARRAY(SELECT CONCAT(first_name, ' ', last_name)) FROM employee WHERE manager_id IS NULL`
      );
      return result.rows[0]?.array || [];
    } catch (err) {
      console.error(err);
  ...
  async getEmployees(): Promise<string[]> {
    try {
      const result = await pool.query(
        `SELECT ARRAY(SELECT CONCAT(employee.first_name, ' ', employee.last_name) FROM employee)`
      );
      return result.rows[0]?.array || [];
    } catch (err) {
      console.error(err);
...
`
  ...
  async addRole() {
    ...
    inquirer
      ...
      .then(async (response) => {
        const departmentId = async function (): Promise<number | null> {
          try {
            const result = await pool.query(
  ...
  async addEmployee() {
    ...
    inquirer
      ...
      .then(async (response) => {
        const roleId = async function (): Promise<number | null> {
          try {
            const result = await pool.query(
              "SELECT id FROM employee_role WHERE title = $1",
              [response.role]
            );
            return result.rows[0]?.id || null;
          } catch (err) {
        ...
        const managerId = async function (): Promise<number | null> {
          try {
            const result = await pool.query(
